...
import ProfessionalTreatmentsClient from "./professional-treatments-client"
...
export default async function ProfessionalTreatmentsPage() {
    ...
    <div className="space-y-6">
      <div className="rounded-lg bg-white p-6 shadow-sm border">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">הטיפולים שלי</h1>
            <p className="text-gray-600">בחר והגדר את הטיפולים שאתה מספק ואת התעריפים שלך</p>
          </div>
        </div>
      </div>

      <ProfessionalTreatmentsClient professional={professionalProfile} />
    </div>
  )
} 