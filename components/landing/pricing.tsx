...
export function LandingPricing() {
  ...
  const additionalServices = [
    ...
    },
    {
      ...
      description: dir === "rtl" ? "מעבר לכך 50% מעלות הטיפול" : "Beyond that 50% of treatment cost"
    },
    {
            ...
            return (
              <div 
                ...
                className={`relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden ${
                  plan.popular ? 'transform scale-105 border-2 border-purple-200' : 'hover:-translate-y-2'
                }`}
              >
                {/* Popular Badge */}
                {plan.popular && (
                ...
                <div className="p-8">
                  {/* Icon */}
                  <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${plan.gradient} mb-6 text-white`}>
