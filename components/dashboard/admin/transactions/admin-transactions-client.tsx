  ...
  const loadWeeklyData = async (weekStart: Date) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/admin/transactions/weekly?start=${weekStart.toISOString().split("T")[0]}&end=${weekEnd.toISOString().split("T")[0]}`
      )
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {!isCurrentWeek && (
                <Button variant="default" size="sm" onClick={goToCurrentWeek}>
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.bookings")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.newVouchers")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.redeemedVouchers")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.newSubscriptions")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.redeemedSubscriptions")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.newCoupons")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.redeemedCoupons")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.newPartnerCoupons")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[120px]">
                    {t("transactions.columns.redeemedPartnerCoupons")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[100px]">
                    {t("transactions.columns.totalRevenue")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[100px]">
                    {t("transactions.columns.totalRedemptions")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[100px]">
                    {t("transactions.columns.professionalCosts")}
                  </TableHead>
                  <TableHead className="text-center font-semibold min-w-[100px]">
                    {t("transactions.columns.officeProfit")}
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                  ...
                  >
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-500">
                          {formatCurrency(day.newVouchers.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-500">
                          {formatCurrency(day.redeemedVouchers.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-500">
                          {formatCurrency(day.newSubscriptions.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-500">
                          {formatCurrency(day.redeemedSubscriptions.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-500">
                          {formatCurrency(day.redeemedCoupons.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-500">
                          {formatCurrency(day.newPartnerCoupons.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-500">
                          {formatCurrency(day.redeemedPartnerCoupons.amount)}
                        </div>
                      </div>
                    </TableCell>
                  ...
                  <TableRow className="bg-gray-100 font-semibold border-t-2">
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.bookings.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.newVouchers.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        <div className="font-bold">
                          {weeklyData.weeklyTotals.redeemedVouchers.count}
                        </div>
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.redeemedVouchers.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        <div className="font-bold">
                          {weeklyData.weeklyTotals.newSubscriptions.count}
                        </div>
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.newSubscriptions.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        <div className="font-bold">
                          {weeklyData.weeklyTotals.redeemedSubscriptions.count}
                        </div>
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.redeemedSubscriptions.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        ...
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.newCoupons.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        <div className="font-bold">
                          {weeklyData.weeklyTotals.redeemedCoupons.count}
                        </div>
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.redeemedCoupons.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        <div className="font-bold">
                          {weeklyData.weeklyTotals.newPartnerCoupons.count}
                        </div>
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.newPartnerCoupons.amount)}
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-center">
                      <div className="text-sm">
                        <div className="font-bold">
                          {weeklyData.weeklyTotals.redeemedPartnerCoupons.count}
                        </div>
                        <div className="text-gray-600">
                          {formatCurrency(weeklyData.weeklyTotals.redeemedPartnerCoupons.amount)}
                        </div>
                      </div>
                    </TableCell>
