...
import type { getUserSubscriptionById } from "@/actions/user-subscription-actions"
...
export default function RedeemSubscriptionContent({ subscription, id }: RedeemSubscriptionContentProps) {
