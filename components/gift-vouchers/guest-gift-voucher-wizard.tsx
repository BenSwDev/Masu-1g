...
export default function GuestGiftVoucherWizard({ treatments }: Props) {
  ...
  // Skip treatment selection when purchasing a monetary voucher
  useEffect(() => {
    if (currentStep === 3 && voucherType === "monetary") {
      setCurrentStep(4)
    }
            ...
            <CardContent className="space-y-2">
              ...
              {voucherType === "monetary" ? (
                ...
                <>
                  ...
                  {selectedDuration && (
                    <div className="flex justify-between"><span>משך:</span><span>{selectedDuration.durationMinutes} דקות</span></div>
                  )}
  ...
  const renderStep = () => {
    ...
    if (currentStep === 3 && voucherType === "monetary") return null
