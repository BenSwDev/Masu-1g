...
import ProfessionalDocumentsClient from "./professional-documents-client"
      ...
      <div className="rounded-lg bg-white p-6 shadow-sm border">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">העלה וניהל את המסמכים הנדרשים לאישור המטפל</p>
          </div>
        </div>
      </div>

      <ProfessionalDocumentsClient professional={professionalProfile} />
    </div>
  )
}
