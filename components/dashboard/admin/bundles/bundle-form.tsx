            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                <div className="border rounded-md p-4 space-y-4">
                  <h3 className="text-base font-medium mb-2">{t("bundles.basicInfo")}</h3>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          <FormLabel>{t("bundles.fields.isActive")}</FormLabel>
                          <FormDescription className="text-xs">{t("bundles.activeDescription")}</FormDescription>
                        </div>
                        <FormControl>
                ...
                <div className="border rounded-md p-4 space-y-4">
                  <h3 className="text-base font-medium mb-2">{t("bundles.bundleDetails")}</h3>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription className="text-xs">{t("bundles.quantityDescription")}</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription className="text-xs">{t("bundles.validityDescription")}</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
              ...
              {/* Right column */}
              <div className="space-y-6">
                <div className="border rounded-md p-4 space-y-4 h-full">
                  <div className="flex flex-col space-y-2 mb-2">
                    <h3 className="text-base font-medium">{t("bundles.fields.treatments")}</h3>
                    <FormDescription className="text-xs">{t("bundles.treatmentsDescription")}</FormDescription>
                  </div>
                            ...
                            {isSelected && (
                              <div className="flex items-center space-x-1">
                                <Button
                                  ...
                                  className="h-6 w-6"
                                  onClick={() =>
                                    updateTreatmentCount(treatment._id, (selectedTreatment?.count || 1) - 1)
                                  }
                                  disabled={selectedTreatment?.count === 1}
                                >
                                  <MinusIcon className="h-3 w-3" />
                                </Button>
                                <span className="text-sm w-5 text-center">{selectedTreatment?.count || 1}</span>
                                <Button
                                  type="button"
                                  variant="outline"
                                  size="icon"
                  ...
                  {selectedTreatments.length === 0 && (
                    <p className="text-sm text-red-500 mt-2">{t("bundles.errors.treatmentsRequired")}</p>
                  )}
                </div>
              </div>
            </div>
