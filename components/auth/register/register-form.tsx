    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="border-turquoise-200">
        <CardHeader className="text-center relative">
          ...
          <CardTitle className="text-2xl font-bold text-turquoise-700">{t("register.welcome")}</CardTitle>
        ...
        <CardContent>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <RadioGroup name="gender" defaultValue="male" className="grid grid-cols-3 gap-3">
                <div className="relative">
                  ...
                  >
                    <svg className={`h-5 w-5 ${iconSpacing}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path
                        strokeLinecap="round"
