...
Write-Host "`n🏥 TESTING ADMIN PROFESSIONAL MANAGEMENT" -ForegroundColor Yellow
...
Write-Host "`n👥 TESTING ADMIN CUSTOMER MANAGEMENT" -ForegroundColor Yellow
Write-Host "=====================================" -ForegroundColor Yellow
...
Write-Host "`n📊 TESTING ADMIN DASHBOARD PAGES" -ForegroundColor Yellow
Write-Host "=================================" -ForegroundColor Yellow
...
Write-Host "`n📱 TESTING GUEST BOOKING FLOWS" -ForegroundColor Yellow
Write-Host "===============================" -ForegroundColor Yellow
...
Write-Host "`n🏠 TESTING LANDING PAGES" -ForegroundColor Yellow
Write-Host "=========================" -ForegroundColor Yellow
...
Write-Host "`n💳 TESTING PAYMENT FLOW VALIDATION" -ForegroundColor Yellow
Write-Host "===================================" -ForegroundColor Yellow
...
Write-Host "`n🎫 TESTING VOUCHER/COUPON VALIDATION" -ForegroundColor Yellow
Write-Host "=====================================" -ForegroundColor Yellow
...
Write-Host "`n📱 TESTING SUBSCRIPTION FLOW VALIDATION" -ForegroundColor Yellow
Write-Host "========================================" -ForegroundColor Yellow
...
Write-Host "`n🏠 TESTING ADDRESS VALIDATION" -ForegroundColor Yellow
Write-Host "==============================" -ForegroundColor Yellow
...
Write-Host "`n👨‍⚕️ TESTING PROFESSIONAL ASSIGNMENT LOGIC" -ForegroundColor Yellow
Write-Host "===========================================" -ForegroundColor Yellow
...
Write-Host "`n📊 TESTING BOOKING STATUS TRANSITIONS" -ForegroundColor Yellow
Write-Host "======================================" -ForegroundColor Yellow
...
if ($failedTests -eq 0) {
    ...
    Write-Host "`n⚠️ Minor issues detected. Review failed tests." -ForegroundColor Yellow
} else {
