...
export default async function UniversalBookTreatmentPage({
  ...
  try {
    ...
    const voucher =
      voucherResult.success && "voucher" in voucherResult
        ? (voucherResult as any).voucher
        : undefined
    const subscription =
      subscriptionResult.success && "subscription" in subscriptionResult
        ? (subscriptionResult as any).subscription
        : undefined
