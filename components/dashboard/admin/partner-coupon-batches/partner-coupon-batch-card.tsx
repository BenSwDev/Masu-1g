...
export function PartnerCouponBatchCard({
  batch,
  onEdit,
  onDelete,
  onViewCoupons,
      ...
      <CardHeader className="flex flex-row items-start justify-between pb-2">
        <div className="flex flex-col gap-1">
          <CardTitle className="text-lg font-semibold">
            {batch.name}
            <div className="text-sm text-muted-foreground font-normal">{batch.codePrefix}-XXX</div>
          </CardTitle>
      ...
      <CardContent className="space-y-2 text-sm">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {batch.couponCount} {t("adminPartnerCouponBatches.columns.total")} (
            {batch.activeCouponsCount} {t("adminPartnerCouponBatches.columns.active")})
          </p>
        </div>
        <div>
