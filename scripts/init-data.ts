...
const ISRAEL_CITIES = [
  ...
  { name: "ראשון לציון", lat: 31.973, lng: 34.8071 },
  { name: "פתח תקווה", lat: 32.0878, lng: 34.8878 },
  { name: "אשדוד", lat: 31.794, lng: 34.6593 },
  ...
  { name: "בת ים", lat: 32.0167, lng: 34.75 },
    ...
    if (existingProfessionalsCount === 0) {
      ...
      if (telAvivCity && treatments.length > 0) {
        ...
        const professionalProfile = new ProfessionalProfile({
          ...
          experience:
            "מטפל מוסמך עם ניסיון של 8 שנים בעיסוי רפואי ועיסוי שוודי. בוגר בית ספר לעיסוי רפואי והולדתי.",
          certifications: ["תעודת עיסוי רפואי", "תעודת עיסוי שוודי", "הסמכה בעיסוי רקמות עמוקות"],
