...
export function LandingFAQ() {
  ...
  const faqs = [
    ...
    },
    {
      question:
        dir === "rtl"
          ? "האם המטפלים מקצועיים ומוסמכים?"
          : "Are the therapists professional and certified?",
      answer:
        dir === "rtl"
    ...
    },
    {
      question:
        dir === "rtl"
          ? "כמה זמן לפני הטיפול צריך להזמין?"
          : "How far in advance should I book before the treatment?",
      answer:
        dir === "rtl"
    ...
    },
    {
      question:
        dir === "rtl"
          ? "מה קורה אם אני צריך לבטל או לדחות?"
    ...
    {
      question:
        dir === "rtl" ? "מה כלול במחיר הטיפול?" : "What is included in the treatment price?",
      answer:
        dir === "rtl"
    ...
    {
      question:
        dir === "rtl" ? "איך אני יודע שהמטפל בדרך?" : "How do I know the therapist is on the way?",
      answer:
        dir === "rtl"
