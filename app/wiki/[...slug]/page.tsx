...
import ShareButton from '@/components/wiki/share-button'
  ...
  try {
                ...
                <div className="grid gap-4">
                  {items.map((item) => (
                    <Link
                      ...
                      className="group block p-6 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors border border-gray-200 dark:border-gray-600"
                    >
    ...
    return (
      <>
                ...
                <div className="p-8 prose prose-lg max-w-none dark:prose-invert prose-headings:text-gray-900 dark:prose-headings:text-white prose-p:text-gray-700 dark:prose-p:text-gray-300" dir="rtl">
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      h1: ({ children }) => (
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                          {children}
                        </h1>
                      ),
                      h2: ({ children }) => (
              ...
              <div className="sticky top-8">
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    תוכן העניינים יוצג כאן אוטומטית
                  </p>
                </div>
              </div>
            </div>
        ...
        <ShareButton title={metadata.title} description={metadata.description} />
      </>
    )
  } catch (err) {
    console.error(err)
