...
} from "@/app/dashboard/(user)/(roles)/admin/customers/actions"
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(summaryStats.averageSpentPerCustomer)}
            </div>
            <p className="text-xs text-muted-foreground">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div className="flex items-center gap-4 w-full md:w-auto">
              ...
              <Select
                ...
                onValueChange={(value: "all" | "guests" | "members") => setUserTypeFilter(value)}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="members">
                    {t("customers.members") || "משתמשים רשומים"}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {customer.activeSubscriptions > 0 && (
                          <Badge variant="outline" className="text-xs">
                            ...
                            {t("customers.subscriptions") || "מנויים"}
                          </Badge>
                        )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">
                        {t("customers.joinDate") || "תאריך הצטרפות"}:
                      </p>
                ...
                <Card>
                  <CardHeader className="pb-2">
                    <CardTitle className="text-sm">
                      {t("customers.statistics") || "סטטיסטיקות"}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <div>
                      <p className="text-sm text-muted-foreground">
                        {t("customers.totalSpent") || "סה״כ הוצאה"}:
                      </p>
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">
                        {t("customers.completedBookings") || "הזמנות שהושלמו"}:
                      </p>
                      <p className="font-medium">{selectedCustomer.statistics.completedBookings}</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">
                        {t("customers.averageBookingValue") || "ערך ממוצע להזמנה"}:
                      </p>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <div>
                      <p className="text-sm text-muted-foreground">
                        {t("customers.activeSubscriptions") || "מנויים פעילים"}:
                      </p>
                      <p className="font-medium">{selectedCustomer.activeSubscriptions}</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">
                        {t("customers.activeVouchers") || "שוברים פעילים"}:
                      </p>
                      <p className="font-medium">{selectedCustomer.activeVouchers}</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">
                        {t("customers.lastActivity") || "פעילות אחרונה"}:
                      </p>
