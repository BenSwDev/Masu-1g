...
import UserSubscriptionEditForm, { type UserSubscriptionEditValues } from "./user-subscription-edit-form"
    ...
    try {
      ...
      if (result.success && result.userSubscription) {
        setUserSubscriptions((prev) =>
          prev.map((s) =>
            String(s._id) === String(result.userSubscription!._id) ? (result.userSubscription as any) : s,
          ),
        )
