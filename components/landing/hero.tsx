        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-turquoise-200 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm font-medium text-turquoise-800">
              {dir === "rtl"
                ? "הפלטפורמה המובילה לטיפולים עד הבית"
                : "Leading At-Home Treatment Platform"}
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-turquoise-600 to-blue-600 hover:from-turquoise-700 hover:to-blue-700 text-white px-8 py-4 text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <Link
                href="/bookings/treatment?category=massages"
            ...
            >
              <Link
                href="/bookings/treatment?category=facial_treatments"
                className="flex items-center gap-2"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-gray-600">
                {dir === "rtl" ? "טיפולים מוצלחים" : "Successful Treatments"}
              </div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-2">500+</div>
              <div className="text-gray-600">
                {dir === "rtl" ? "מטפלים מקצועיים" : "Professional Therapists"}
              </div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 mb-2">98%</div>
              <div className="text-gray-600">
                {dir === "rtl" ? "שביעות רצון" : "Customer Satisfaction"}
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-col items-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                asChild
                size="lg"
                className="bg-gradient-to-r from-turquoise-600 to-blue-600 text-white"
              >
