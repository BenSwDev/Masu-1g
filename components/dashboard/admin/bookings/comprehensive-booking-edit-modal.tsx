    ...
    try {
      ...
      if (result.success) {
        ...
        setEditedBooking(prev => ({
          ...prev,
          professionalId: { _id: professionalId, name: "" } as any,
        }))
        queryClient.invalidateQueries({ queryKey: ["adminBookings"] })
      } else {
        const errorMessage =
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full" dir="rtl">
          <TabsList
            className={`grid w-full ${booking.recipientName || booking.recipientPhone ? "grid-cols-8" : "grid-cols-7"}`}
          >
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setEditedBooking((prev: any) => ({ ...prev, status: value as any }))
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      type="date"
                      value={
                        safeFormatDate(booking.bookingDateTime, "yyyy-MM-dd") !==
                      ...
                      onChange={e => {
                        if (e.target.value && booking.bookingDateTime) {
                          ...
                          setEditedBooking((prev: any) => ({
                            ...prev,
                            bookingDateTime: newDate.toISOString(),
                          }))
                        }
                      }}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="time"
                      value={
                        safeFormatDate(booking.bookingDateTime, "HH:mm") !==
                        t("adminBookings.notSpecified")
                          ? safeFormatDate(booking.bookingDateTime, "HH:mm")
                          : ""
                      }
                      onChange={e => {
                        if (e.target.value && booking.bookingDateTime) {
                          ...
                          setEditedBooking((prev: any) => ({
                            ...prev,
                            bookingDateTime: currentDate.toISOString(),
                          }))
                        }
                      }}
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      value={booking.isFlexibleTime ? t("common.yes") : t("common.no")}
                      disabled
                    />
                  </div>
                  {booking.flexibilityRangeHours && (
                    <div className="space-y-2">
                      ...
                      <Input
                        value={`${booking.flexibilityRangeHours} ${t("adminBookings.hours")}`}
                        disabled
                      />
                    </div>
                  )}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      value={treatment?.category || t("adminBookings.notSpecified")}
                      disabled
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      value={treatment?.pricingType || t("adminBookings.notSpecified")}
                      disabled
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      value={`${treatment?.defaultDurationMinutes || 60} ${t("adminBookings.minutes")}`}
                      disabled
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      value={`₪${booking.priceDetails?.basePrice || treatment?.fixedPrice || 0}`}
                      disabled
                    />
                  </div>
                </div>
                      ...
                      {treatment.durations.map((duration: any, index: number) => (
                        <div key={index} className="p-2 bg-gray-50 rounded border">
                          <div className="text-sm font-medium">
                            {duration.minutes} {t("adminBookings.minutes")}
                          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      value={`₪${booking.priceDetails?.finalAmount || 0}`}
                      disabled
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setEditedBooking((prev: any) => ({
                          ...prev,
                          bookedByUserName: e.target.value,
                        }))
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setEditedBooking((prev: any) => ({
                          ...prev,
                          bookedByUserEmail: e.target.value,
                        }))
                      }
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <PhoneInput
                      ...
                      onPhoneChange={value =>
                        setEditedBooking((prev: any) => ({ ...prev, bookedByUserPhone: value }))
                      }
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          value={safeFormatDate(client.createdAt, "dd/MM/yyyy HH:mm")}
                          disabled
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          value={safeFormatDate(client.updatedAt, "dd/MM/yyyy HH:mm")}
                          disabled
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          value={client.roles?.join(", ") || t("adminBookings.notSpecified")}
                          disabled
                        />
                      </div>
                      {client.activeRole && (
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="p-3 bg-gray-50 rounded border">
                          <div className="text-sm">
                            <strong>{t("adminBookings.preferredTherapistGender")}:</strong>{" "}
                            {client.treatmentPreferences.therapistGender ||
                              t("adminBookings.notSpecified")}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="p-3 bg-gray-50 rounded border">
                          <div className="text-sm space-y-1">
                            <div>
                              <strong>{t("adminBookings.methods")}:</strong>{" "}
                              {client.notificationPreferences.methods?.join(", ") ||
                                t("adminBookings.notSpecified")}
                            </div>
                            <div>
                              <strong>{t("adminBookings.language")}:</strong>{" "}
                              {client.notificationPreferences.language ||
                                t("adminBookings.notSpecified")}
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <PhoneInput
                          fullNumberValue={
                            editedBooking.recipientPhone || booking.recipientPhone || ""
                          }
                          onPhoneChange={(value: string) =>
                            setEditedBooking((prev: any) => ({ ...prev, recipientPhone: value }))
                          }
                        />
                      </div>
                    </div>
                  ...
                  <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div className="flex items-center gap-2 text-yellow-800 mb-2">
                      ...
                      <span className="font-medium">
                        {t("adminBookings.noProfessionalAssigned")}
                      </span>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                      <div className="flex items-center gap-2 text-green-800 mb-2">
                        ...
                        <span className="font-medium">
                          {t("adminBookings.assignedProfessional")}
                        </span>
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={handleAssignProfessional}>
                        <SelectTrigger>
                          <SelectValue
                            placeholder={t("adminBookings.chooseDifferentProfessional")}
                          />
                        </SelectTrigger>
                        <SelectContent>
                          {professionalsData?.professionals?.map(prof => (
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.01"
                        value={
                          booking.priceDetails?.treatmentPriceAfterSubscriptionOrTreatmentVoucher ||
                          0
                        }
                        disabled
                      />
                  ...
                  {booking.priceDetails?.surcharges &&
                    booking.priceDetails.surcharges.length > 0 && (
                      <div className="space-y-2">
                            ...
                            >
                              ...
                              {surcharge.professionalShare && (
                                <div className="text-xs text-gray-600 mt-1">
                                  {t("adminBookings.professionalShare")}:{" "}
                                  {surcharge.professionalShare.amount}
                ...
                {(appliedCoupon || appliedGiftVoucher || redeemedSubscription) && (
                  <div className="space-y-4">
                    <h4 className="font-medium text-gray-900">
                      {t("adminBookings.appliedDiscountsAndVouchers")}
                    </h4>
                    ...
                    {appliedCoupon && (
                      <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                        ...
                        <div className="text-sm space-y-1">
                          <div>
                            <strong>{t("adminBookings.couponCode")}:</strong> {appliedCoupon.code}
                          </div>
                          <div>
                            <strong>{t("adminBookings.couponName")}:</strong> {appliedCoupon.name}
                          </div>
                          <div>
                            <strong>{t("adminBookings.discountType")}:</strong>{" "}
                            {appliedCoupon.discountType}
                          </div>
                          <div>
                            <strong>{t("adminBookings.discountValue")}:</strong>{" "}
                    ...
                    {appliedGiftVoucher && (
                      <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                        <div className="flex items-center gap-2 text-orange-800 mb-2">
                          <span className="font-medium">
                            {t("adminBookings.appliedGiftVoucher")}
                          </span>
                        </div>
                        <div className="text-sm space-y-1">
                          <div>
                            <strong>{t("adminBookings.voucherCode")}:</strong>{" "}
                            {appliedGiftVoucher.code}
                          </div>
                          <div>
                            <strong>{t("adminBookings.originalAmount")}:</strong> ₪
                            {appliedGiftVoucher.originalAmount}
                          </div>
                          <div>
                            <strong>{t("adminBookings.remainingAmount")}:</strong> ₪
                            {appliedGiftVoucher.remainingAmount}
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    {redeemedSubscription && (
                      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <div className="flex items-center gap-2 text-blue-800 mb-2">
                          <span className="font-medium">
                            {t("adminBookings.redeemedSubscription")}
                          </span>
                        </div>
                        <div className="text-sm space-y-1">
                          <div>
                            <strong>{t("adminBookings.subscriptionName")}:</strong>{" "}
                            {redeemedSubscription.subscriptionId?.name}
                          </div>
                          <div>
                            <strong>{t("adminBookings.treatmentName")}:</strong>{" "}
                            {redeemedSubscription.treatmentId?.name}
                          </div>
                          <div>
                            <strong>{t("adminBookings.usedQuantity")}:</strong>{" "}
                            {redeemedSubscription.usedQuantity}
                          </div>
                          <div>
                            <strong>{t("adminBookings.remainingQuantity")}:</strong>{" "}
                            {redeemedSubscription.remainingQuantity}
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <div className="space-y-4">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="pending">
                            {t("adminBookings.paymentStatuses.pending")}
                          </SelectItem>
                          <SelectItem value="paid">
                            {t("adminBookings.paymentStatuses.paid")}
                          </SelectItem>
                          <SelectItem value="failed">
                            {t("adminBookings.paymentStatuses.failed")}
                          </SelectItem>
                          <SelectItem value="not_required">
                            {t("adminBookings.paymentStatuses.notRequired")}
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  ...
                  {paymentMethod && (
                    <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                      ...
                      <div className="text-sm space-y-1">
                        <div>
                          <strong>{t("adminBookings.paymentType")}:</strong> {paymentMethod.type}
                        </div>
                        {paymentMethod.brand && (
                          <div>
                            <strong>{t("adminBookings.cardBrand")}:</strong> {paymentMethod.brand}
                          </div>
                        )}
                        {paymentMethod.last4 && (
                          <div>
                            <strong>{t("adminBookings.last4Digits")}:</strong> ****{" "}
                            {paymentMethod.last4}
                          </div>
                        )}
                        <div>
                          <strong>{t("adminBookings.displayName")}:</strong>{" "}
          ...
          <TabsContent value="financial" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-medium text-gray-900">
                    {t("adminBookings.professionalPaymentBreakdown")}
                  </h4>
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg space-y-3">
                    {(booking.priceDetails?.baseProfessionalPayment || 0) > 0 && (
                      <div className="flex justify-between items-center">
                        <span className="text-sm">
                          {t("adminBookings.baseProfessionalPayment")}:
                        </span>
                        <span className="font-medium">
                    ...
                    {(booking.priceDetails?.surchargesProfessionalPayment || 0) > 0 && (
                      <div className="flex justify-between items-center">
                        <span className="text-sm">
                          {t("adminBookings.surchargesProfessionalPayment")}:
                        </span>
                        <span className="font-medium">
                ...
                <div className="space-y-4">
                  <h4 className="font-medium text-gray-900">
                    {t("adminBookings.officeCommission")}
                  </h4>

                  <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                    <div className="flex justify-between items-center">
                      <span className="font-medium">
                        {t("adminBookings.totalOfficeCommission")}:
                      </span>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-300 text-sm text-gray-600">
                      <div className="space-y-1">
                        <div>
                          חישוב: מה שהלקוח משלם (₪{booking.priceDetails?.finalAmount || 0}) - מה
                          שהמטפל מקבל (₪{booking.priceDetails?.totalProfessionalPayment || 0})
                        </div>
                        {(booking.priceDetails?.totalOfficeCommission || 0) < 0 && (
                ...
                <div className="space-y-4">
                  <h4 className="font-medium text-gray-900">
                    {t("adminBookings.professionalPaymentStatus")}
                  </h4>
                ...
                <div className="p-4 bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-lg">
                  <h4 className="font-medium text-gray-900 mb-3">
                    {t("adminBookings.financialSummary")}
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                    ...
                    <div className="p-3 bg-white rounded border">
                      <div className="text-xs text-gray-500">
                        {t("adminBookings.professionalReceives")}
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      <h4 className="font-medium text-blue-800 mb-3">
                        {t("adminBookings.bookingAddress")}
                      </h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <Label className="text-xs text-blue-600">
                            {t("adminBookings.fullAddress")}
                          </Label>
                        ...
                        <div>
                          <Label className="text-xs text-blue-600">
                            {t("adminBookings.street")}
                          </Label>
                          <div>
                            {addressSnapshot.street} {addressSnapshot.streetNumber}
                          </div>
                        </div>
                        {addressSnapshot.apartment && (
                          <div>
                            <Label className="text-xs text-blue-600">
                              {t("adminBookings.apartment")}
                            </Label>
                        ...
                        {addressSnapshot.otherInstructions && (
                          <div className="col-span-2">
                            <Label className="text-xs text-blue-600">
                              {t("adminBookings.otherInstructions")}
                            </Label>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={e =>
                      setEditedBooking(prev => ({ ...prev, adminNotes: e.target.value }) as any)
                    }
                    rows={4}
