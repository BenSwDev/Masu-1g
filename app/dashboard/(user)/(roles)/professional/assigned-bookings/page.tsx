...
import ProfessionalAssignedBookingsClient from "./professional-assigned-bookings-client"
...
export default async function ProfessionalAssignedBookingsPage() {
      ...
      <div className="rounded-lg bg-white p-6 shadow-sm border">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">הזמנות שנקבעו אצלך ומחכות לטיפול</p>
          </div>
        </div>
      </div>

      <ProfessionalAssignedBookingsClient professional={professionalProfile} />
    </div>
  )
} 